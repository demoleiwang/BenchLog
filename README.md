...
| Category | Benchmarks |
|---|---|
| **[Coding](benchmarks/coding/)** | [HumanEval](benchmarks/coding/HumanEval.md), [SWE-bench Verified](benchmarks/coding/SWE-bench-Verified.md), [SWE-bench Pro](benchmarks/coding/SWE-bench-Pro.md), [Multi-SWE-Bench](benchmarks/coding/Multi-SWE-Bench.md), [LiveCodeBench](benchmarks/coding/LiveCodeBench.md), [Aider-Polyglot](benchmarks/coding/Aider-Polyglot.md), [BigCodeBench](benchmarks/coding/BigCodeBench.md), [ArtifactsBench](benchmarks/coding/ArtifactsBench.md) |
| **[Reasoning](benchmarks/reasoning/)** | [GPQA Diamond](benchmarks/reasoning/GPQA-Diamond.md), [AIME 2025](benchmarks/reasoning/AIME-2025.md), [HMMT 2025](benchmarks/reasoning/HMMT-2025.md), [ARC-AGI-2](benchmarks/reasoning/ARC-AGI-2.md), [HLE](benchmarks/reasoning/HLE.md), [FrontierMath](benchmarks/reasoning/FrontierMath.md), [FrontierScience](benchmarks/reasoning/FrontierScience.md) |
| **[Agent](benchmarks/agent/)** | **Assistant / general**: [GAIA](benchmarks/agent/GAIA.md), [AgentBench](benchmarks/agent/AgentBench.md) · **Tool use**: [τ-bench](benchmarks/agent/tau-bench.md), [BFCL](benchmarks/agent/BFCL.md), [MCPMark](benchmarks/agent/MCPMark.md), [MCP-Bench](benchmarks/agent/MCP-Bench.md), [Tool-Decathlon](benchmarks/agent/Tool-Decathlon.md) · **GUI / Web / Mobile**: [OSWorld](benchmarks/agent/OSWorld.md), [WebArena](benchmarks/agent/WebArena.md), [VisualWebArena](benchmarks/agent/VisualWebArena.md), [Mind2Web](benchmarks/agent/Mind2Web.md), [Online-Mind2Web](benchmarks/agent/Online-Mind2Web.md), [AndroidWorld](benchmarks/agent/AndroidWorld.md), [ScreenSpot-Pro](benchmarks/agent/ScreenSpot-Pro.md), [ClawBench](benchmarks/agent/ClawBench.md), [Terminal-Bench](benchmarks/agent/Terminal-Bench.md) · **Deep research**: [BrowseComp](benchmarks/agent/BrowseComp.md), [DeepSearchQA](benchmarks/agent/DeepSearchQA.md), [WideSearch](benchmarks/agent/WideSearch.md), [DeepResearch-Bench](benchmarks/agent/DeepResearch-Bench.md) · **Planning / skills**: [DeepPlanning](benchmarks/agent/DeepPlanning.md), [SkillsBench](benchmarks/agent/SkillsBench.md), [VitaBench](benchmarks/agent/VitaBench.md) · **Domain-specific**: [SWE-Lancer](benchmarks/agent/SWE-Lancer.md), [MLE-Bench](benchmarks/agent/MLE-Bench.md), [MLR-Bench](benchmarks/agent/MLR-Bench.md), [GDPval](benchmarks/agent/GDPval.md) · **Trajectory-aware eval**: [Claw-Eval](benchmarks/agent/Claw-Eval.md) |
| **[Knowledge](benchmarks/knowledge/)** | [MMLU-Pro](benchmarks/knowledge/MMLU-Pro.md), [SuperGPQA](benchmarks/knowledge/SuperGPQA.md), [HealthBench](benchmarks/knowledge/HealthBench.md), [SimpleQA](benchmarks/knowledge/SimpleQA.md) |
| **[Multimodal](benchmarks/multimodal/)** | [MMMU](benchmarks/multimodal/MMMU.md), [MMMU-Pro](benchmarks/multimodal/MMMU-Pro.md), [CharXiv](benchmarks/multimodal/CharXiv.md), [MathVista](benchmarks/multimodal/MathVista.md), [VideoMME](benchmarks/multimodal/VideoMME.md) |
| **[Long context](benchmarks/long-context/)** | [RULER](benchmarks/long-context/RULER.md), [LongBench-v2](benchmarks/long-context/LongBench-v2.md) |
| **[Safety](benchmarks/safety/)** | [ClawsBench](benchmarks/safety/ClawsBench.md), [AgentHarm](benchmarks/safety/AgentHarm.md), [HarmBench](benchmarks/safety/HarmBench.md), [WMDP](benchmarks/safety/WMDP.md) |

### Latest digests

- [2026-04-28](digests/2026-04-28.md) — DeepSeek V4-Pro / V4-Flash launched 2026-04-24 (open-weights, Apache 2.0, **LiveCodeBench 93.5 new SOTA, Codeforces 3,206**); Claude Opus 4.7 primary source resolved (SWE-bench Verified 87.6%, SWE-bench Pro 64.3%); 10 prior-session benchmark entries committed (inventory 47 → 57).
- [2026-04-24](digests/2026-04-24.md) — four frontier releases in two weeks: Claude Mythos Preview, Kimi K2.6, Hy3-preview (Tencent Hunyuan 3), GPT-5.5. Mythos is new SOTA on SWE-bench Verified / GPQA / HLE / OSWorld; GPT-5.5 Pro tops BrowseComp at 90.1%.
